...
export const subsectionTitleClass = "text-2xl font-bold text-text md:text-3xl";
...
export const accentButtonClass =
  "inline-block rounded-md bg-accent px-8 py-3 text-sm font-semibold text-white transition-all duration-300 ease-out border-[1.5px] border-transparent hover:border-accent hover:bg-zinc-950 active:scale-[0.98] active:bg-zinc-700";

export const accentButtonSmallClass =
  "inline-block rounded-md bg-accent px-6 py-3 text-sm font-semibold text-white transition-all duration-300 ease-out border-[1.5px] border-transparent hover:border-accent hover:bg-zinc-950 active:scale-[0.98] active:bg-zinc-700";

// Footer gibi koyu arka planlarda — zinc-800 açık göründüğü için daha koyu hover
export const accentButtonFitOnDarkClass =
  "rounded-md bg-accent px-4 py-2 text-sm text-white transition-all duration-300 ease-out w-fit border border-transparent hover:border-accent hover:bg-black active:scale-[0.98] active:bg-zinc-950";
...
export const statsGridClass = "grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-6";
