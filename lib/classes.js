...
export const accentButtonFitOnDarkClass =
  "rounded-md bg-accent px-4 py-2 text-sm text-white transition-all w-fit border border-transparent hover:border-accent hover:bg-black active:scale-[0.98] active:bg-zinc-950";
